        ...
        <form class="form-horizontal" action="{{route('insertdoctor')}}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9"><input type="text" name="building" placeholder="building" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-3 control-label">Street</label>
                <div class="col-lg-9"><input type="text" name="street" placeholder="Street" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9"><input type="text" name="educational_qualification" placeholder="Educational Qalification" class="form-control">
                </div>
            </div>

            <div class="form-group">
                <label class="col-lg-3 control-label">Blood Pressure Systolic</label>
                <div class="col-lg-9"><input type="text" name="blood_pressure_systolic" placeholder="Blood Pressure Systolic" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-3 control-label">Blood Pressure Diastolic</label>
                <div class="col-lg-9"><input type="text" name="blood_pressure_diastolic" placeholder="Blood Pressure Diastolic" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-3 control-label">Height</label>
                <div class="col-lg-9"><input type="text" name="height" placeholder="Height in cm" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-3 control-label">Weight</label>
                <div class="col-lg-9"><input type="text" name="weight" placeholder="Weight in kg" class="form-control">
                </div>
            </div>
