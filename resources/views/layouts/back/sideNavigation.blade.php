                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                              <a href="{{route('add')}}">Add An User</a>
                            </li>
                            <li>
                              <a href="{{route('viewall')}}">View All Users</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-star"></i> <span class="nav-label">Report Generate</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-usd"></i> <span class="nav-label">Payment Method</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                              <a href="{{route('add')}}">Add Product</a>
                              <a href="{{route('viewall')}}">All Products</a>
                              <hr>
                            </li>
                        </ul>
                    </li>
